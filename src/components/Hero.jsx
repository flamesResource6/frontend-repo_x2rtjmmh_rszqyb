    ...
    <section className="relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-28 pb-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <motion.h1 initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.6}} className="text-4xl sm:text-6xl font-bold text-white tracking-tight">
              Discover and Monetize Intelligence
            </motion.h1>
            <p className="mt-6 text-lg text-blue-200/90 max-w-xl">
              A curated marketplace for high-signal research, models, and datasets. Submit intelligence, browse listings, and support top contributors.
            </p>
